...
<title><? echo("Releases for $release_name"); ?></title></head>
<body bgcolor="#FFFFFF">
...
<?	echo("<h1>$release_name</h1>");
	...
	$query = "SELECT release_id, release_country_sale, release_format, release_type, release_year
				FROM release
	...
	while (list($release_id, $release_country_sale, $release_format, $release_type, $release_year) = mysql_fetch_row($result)) {
